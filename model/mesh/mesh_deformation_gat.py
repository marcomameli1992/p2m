...
class MeshDeformationBlock(nn.Module):
    ...
    def __init__(self, transformer_name: str, feature_shape_dim) -> None:
        ...
        feature_dict: dict = {
            ...
            'microsoft/swinv2-large-patch4-window12to16-192to256-22kto1k-ft': 48,
            'microsoft/swinv2-large-patch4-window12-192-22k': 48,
            'microsoft/swinv2-small-patch4-window8-256': 48,
            'microsoft/swinv2-base-patch4-window12to16-192to256-22kto1k-ft': 48,
            'microsoft/swinv2-base-patch4-window16-256': 48,
            'microsoft/swinv2-base-patch4-window12-192-22k': 48,
            'microsoft/swinv2-base-patch4-window8-256': 48,
            'microsoft/swinv2-small-patch4-window16-256': 48,
            'microsoft/swinv2-tiny-patch4-window16-256': 48,
            'microsoft/swinv2-tiny-patch4-window8-256': 48,
        }
